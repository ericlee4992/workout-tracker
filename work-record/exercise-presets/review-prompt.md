...
D24, D27 are the ones this can violate), then `work-record/exercise-presets/spec.md` and `issues/`.
...
`work-record/exercise-presets/codex-review.md`: findings by severity, file/line, the decision each
