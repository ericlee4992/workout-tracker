...
ticket, so you review). Ticket: work-record/ui-redesign/issues/09-empty-states-icon-live-activity.md;
the plan: work-record/ui-redesign/spec.md ticket 09 (NOTE two documented deviations: amber, not the
...
Screenshots: work-record/ui-redesign/screenshots/09/ (08-empty-history, 08-empty-gyms, 01-root) and
the icon PNG itself.
...
source files. Write to work-record/ui-redesign/codex-review-09.md
