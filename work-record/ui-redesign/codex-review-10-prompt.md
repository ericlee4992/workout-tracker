...
work-record/ui-redesign/issues/10-start-second-pass.md (job/state sentences, the chosen structure,
...
Captures: work-record/ui-redesign/screenshots/10/ — 04-start (live state, resume capsule),
...
work-record/ui-redesign/canvas/start/ (Main.dc.html = the chosen composition; MainLive = the live state).
...
say "clear" in one paragraph. Do not modify source files. Write to work-record/ui-redesign/codex-review-10.md
