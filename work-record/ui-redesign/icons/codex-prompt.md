Design task (not a review). Read work-record/ui-redesign/icons/brief.md first — five muscle-family
...
Produce, in work-record/ui-redesign/icons/codex/: chest.png, back.png, shoulders.png, arms.png,
...
say so in the README. Also write work-record/ui-redesign/icons/codex/contact-sheet.png: the five on
...
work-record/ui-redesign/icons/codex/DONE.md with one paragraph on what you made and any limitation.
