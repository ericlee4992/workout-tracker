...
body maps (work-record/ui-redesign/icons/codex2/) as two-layer template assets in the app. The user
...
work-record/ui-redesign/issues/12-muscle-family-icons.md. Boundary: main..HEAD on branch
...
Captures work-record/ui-redesign/screenshots/12/: 04-start-fixture(-axl), 04-template-detail-fixture,
...
work-record/ui-redesign/codex-review-12.md
