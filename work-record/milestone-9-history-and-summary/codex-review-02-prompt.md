...
7b706e7). Read work-record/milestone-9-history-and-summary/spec.md and
issues/02-workout-name.md for intent, docs/DECISIONS.md for D23, D28-D32
(export), D47, and work-record/milestone-3-export/spec.md for the export format.
...
work-record/milestone-9-history-and-summary/codex-review-02.md
