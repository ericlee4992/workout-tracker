...
work-record/scanner-accuracy/issues/05-ask-ai-escalation.md (what to build, acceptance criteria,
resolution). Background: work-record/scanner-accuracy/issues/llm-reader-experiment.md and D53 /
...
change. Do not modify source files. Write to work-record/scanner-accuracy/codex-review-05.md
