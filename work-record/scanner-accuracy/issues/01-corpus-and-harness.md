...
**Corpus.** `work-record/scanner-accuracy/corpus/` — photos gitignored, `manifest.json` committed.
...
`work-record/scanner-accuracy/reports/latest.md` with a per-photo row (read text, top candidate and
