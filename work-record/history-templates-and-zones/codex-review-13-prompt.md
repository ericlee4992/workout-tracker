...
work-record/history-templates-and-zones/issues/13-save-as-template-from-history.md. Boundary:
...
"clear" in one paragraph. Write to work-record/history-templates-and-zones/codex-review-13.md
