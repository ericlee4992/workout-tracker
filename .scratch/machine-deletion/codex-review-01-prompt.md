...
mid-workout. Ticket: .scratch/machine-deletion/issues/01-delete-machines.md (what to build,
...
source files. Write to .scratch/machine-deletion/codex-review-01.md
