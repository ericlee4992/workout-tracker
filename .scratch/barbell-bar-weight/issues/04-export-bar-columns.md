...
- `.scratch/milestone-3-export/spec.md` — column list and JSON sample
...
- CSV: `barWeight`, `barWeightKg` **appended** after `presetName` (29 → 31). Appending is safe,
  ...
  correctly.
- Update `.scratch/milestone-3-export/spec.md`: the column table, the count, and the JSON sample.
...
collector normalizing the bar through the row's own unit. `.scratch/milestone-3-export/spec.md`
