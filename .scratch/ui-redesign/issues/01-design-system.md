...
Spec: `.scratch/ui-redesign/spec.md` (the approved plan). This ticket adds the tokens and
...
### The implementation (Codex's report: `.scratch/ui-redesign/codex-design-report.md`)
