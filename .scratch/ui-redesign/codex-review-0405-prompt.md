...
you review). Ticket: .scratch/ui-redesign/issues/04-05-start-and-settings.md; the plan:
.scratch/ui-redesign/spec.md (tickets 04 and 05, and the constraints — copy policy, ids/strings the
...
Screenshots: .scratch/ui-redesign/screenshots/05/05-settings.png and 04-start.png.
...
source files. Write to .scratch/ui-redesign/codex-review-0405.md
