...
| `.scratch/ui-redesign/tools/` | Repeatable class-by-class test runner and manifest-based PNG export |
...
xcrun xcresulttool export attachments \
  --path .scratch/ui-redesign/results/codex.xcresult \
  --output-path .scratch/ui-redesign/screenshots/codex-raw
python3 .scratch/ui-redesign/tools/export-codex-screenshots.py
bash .scratch/ui-redesign/tools/run-codex-gates.sh
```
