Design task, round 2 (not a review). Your first set is in .scratch/ui-redesign/icons/codex/ and
the brief in .scratch/ui-redesign/icons/brief.md. The user has now given a DIRECTION with two
reference images — read them: .scratch/ui-redesign/icons/ref/muscle-map-lines.png (a line-drawn
...
.scratch/ui-redesign/icons/codex2/{chest,back,shoulders,arms,legs}.png, a contact-sheet.png of
...
or simctl. When finished write .scratch/ui-redesign/icons/codex2/DONE.md (one paragraph).
