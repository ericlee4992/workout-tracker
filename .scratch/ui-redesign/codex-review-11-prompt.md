...
.scratch/ui-redesign/issues/11-icons-and-template-detail.md (the user's words, job/state
...
Captures: .scratch/ui-redesign/screenshots/11/ — 04-start-templates (tile with family icons,
...
say "clear" in one paragraph. Do not modify source files. Write to .scratch/ui-redesign/codex-review-11.md
