...
Context: the UI redesign (tickets 01–09, `.scratch/ui-redesign/`, D54) shipped and the user said
...
Do not modify files. Write to .scratch/ui-redesign/codex-review-skill.md
