...
.scratch/ui-redesign/codex-review-06.md; the response is in
.scratch/ui-redesign/issues/06-history.md under "Codex review 06 — response".
...
Write to .scratch/ui-redesign/codex-review-06b.md
