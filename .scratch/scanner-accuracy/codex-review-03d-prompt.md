...
.scratch/scanner-accuracy/codex-review-03c.md. Boundary of the fixes: c744dbd..HEAD (one
...
modify source files. Write to .scratch/scanner-accuracy/codex-review-03d.md
